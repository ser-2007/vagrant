...
app.config['MYSQL_DATABASE_USER'] = 'serkan'
...
# Write a function named `home` which returns 'Welcome to the Serkan's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Serkan's Bookstore API Service"
